...
public class Device extends Item {
     ...
     */
    public Device(Container parent, long id, Type type, ValueType valueType) {
        super(parent, id);
    ...
    /**
     * Asks the central unit to change the value of the actuator device, if the type of the value
     * is binary. If the device is a sensor, or the value type is not binary,
     * a {@link java.lang.IllegalStateException} is thrown. If the current value of the device
     * is the same than requested, nothing happens.
     *
     * The value of the device is not changed immediately. This method only delegates the request
     * to the central unit.
     *
     * @param value The requested new binary value for the device.
     * @exception java.lang.IllegalStateException If the type of the device is not actuator.
     * @exception java.lang.IllegalStateException If the type of the value is not binary.
     */
    public void changeBinaryValue(boolean value) {
        if (type != Type.ACTUATOR)
            throw new IllegalStateException("Type is not actuator.");
    ...
    /**
     * Asks the central unit to change the value of the actuator device, if the type of the value
     * is decimal. If the device is a sensor, or the value type is not binary,
     * a {@link java.lang.IllegalStateException} is thrown. If the current value of the device
     * is the same than requested, nothing happens.
     *
     * The value of the device is not changed immediately. This method only delegates the request
     * to the central unit.
     *
     * @param value The requested new decimal value for the device.
     * @exception java.lang.IllegalStateException If the type of the device is not actuator.
     * @exception java.lang.IllegalStateException If the type of the value is not decimal.
     */
    public void changeDecimalValue(double value) {
        if (type != Type.ACTUATOR)
            throw new IllegalStateException("Type is not actuator.");
        if (valueType != ValueType.DECIMAL)
            throw new IllegalStateException("Value type is not decimal.");

        if (this.decimalValue == value)
            return;

        getCentralUnit().changeDecimalValue(this, value);
    }
     ...
     *
     * This method is for protocol implementations only. For user-initiated changes to the value
     * the {@link #changeBinaryValue(boolean)} method must be used.
     *
     * @see #changeBinaryValue(boolean)
     ...
     *
     * This method is for protocol implementations only. For user-initiated changes to the value
     * the {@link #changeDecimalValue(double)} method must be used.
     *
     * @see #changeDecimalValue(double)
    ...
    /**
     * Sets the unit and the abbreviation of the unit of the decimal value of the device, if the
